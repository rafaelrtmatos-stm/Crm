...
export async function saveMaquina(
  ...
  const payload: any = {
    ...
    categoria_produto: data.categoriaProduto?.trim() || null,
    ...
    modo_impressao: data.modoImpressao || 'standard',
    velocidade_cabeca_mms: Number(data.velocidadeCabecaMmS) || 400,
    calib_setup_min: data.calibSetupMin !== undefined && data.calibSetupMin !== null && !Number.isNaN(Number(data.calibSetupMin)) ? Number(data.calibSetupMin) : null,
    calib_k_mms: data.calibKMms !== undefined && data.calibKMms !== null && !Number.isNaN(Number(data.calibKMms)) ? Number(data.calibKMms) : null,
    velocidade_hispeed_m2h: data.velocidadeHispeedM2H !== undefined && data.velocidadeHispeedM2H !== null && !Number.isNaN(Number(data.velocidadeHispeedM2H)) ? Number(data.velocidadeHispeedM2H) : null,
  ...
  try {
    ...
    const fallbackItem: Maquina = {
      ...
      modoImpressao: data.modoImpressao || 'standard',
      velocidadeCabecaMmS: Number(data.velocidadeCabecaMmS) || 400,
      calibSetupMin: data.calibSetupMin,
      calibKMms: data.calibKMms,
      velocidadeHispeedM2H: data.velocidadeHispeedM2H,
